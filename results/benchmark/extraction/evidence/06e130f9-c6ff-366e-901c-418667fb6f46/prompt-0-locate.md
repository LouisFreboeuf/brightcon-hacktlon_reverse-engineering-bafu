...
Dataset: `NOx retained, in SCR` [GLO], 1 kg, BAFU category power plants / unspecified.
Metadata: includedProcesses: The module describes the operation of a Selective Catalytic Reduction DeNOx. The module includes the ammonia requirement and its transport as well as the disposal of the used catalysator. · technology: Average installed technology in the 1990s. · comment: The assumed efficiency of the SCR is about 80 %. The waste includes the used catalysator.;
Synonyms: DeNOx; 
