...
- item: disposal, building, bulk iron (excluding reinforcement), to sorting plant  (input)
  quote:            disposal, building, bulk         9.906E-01                 1.126                   Entsorgung Metall
...
- item: disposal, building, paint on metal, to sorting plant  (input)
  quote:            on metal, to sorting plant,                                1.05 (2,2,3,2,3,4)      be
  search: disposal building paint on metal sorting plant
  candidates:
    - Disposal, building, paint on metal, to sorting plant [CH] (kilogram, 4 inputs)
    - Disposal, building, paint on walls, to sorting plant [CH] (kilogram, 5 inputs)
    - xx Disposal, building, emulsion paint on walls, to sorting plant [CH] (kilogram, 5 inputs)
- item: disposal, building, paint on metal, to final disposal  (input)
  quote:            on metal, to final disposal,                               1.05 (2,2,3,2,3,4)      be
  search: disposal building paint on metal final disposal
  candidates:
    - Disposal, building, paint on metal, to final disposal [CH] (kilogram, 2 inputs)
    - Disposal, building, window frame, wood-metal, opaquely painted, m2 visible, to final disposal [CH] (square meter, 11 inputs)
    - Disposal, building, window frame, wood-metal, opaquely painted, wall opening, to final disposal [CH] (square meter, 11 inputs)
    - Disposal, building, window frame, wood-metal, opaquely painted, Baumgartner, wall opening, to final disposal [CH] (square meter, 0 inputs, aggregated)
    - Disposal, building, paint on metal, to sorting plant [CH] (kilogram, 4 inputs)
    - Disposal, building, paint on wood, to final disposal [CH] (kilogram, 2 inputs)
    - Disposal, building, paint remains, to final disposal [CH] (kilogram, 2 inputs)
    - xx Disposal, building, paint on walls, to final disposal [CH] (kilogram, 2 inputs)
