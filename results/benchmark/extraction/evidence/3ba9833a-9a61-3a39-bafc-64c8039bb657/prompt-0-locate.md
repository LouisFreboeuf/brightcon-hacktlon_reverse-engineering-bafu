...
Dataset: `Natural gas, production AZ, at long-distance pipeline` [GLO], 1 MJ, BAFU category natural gas / transport.
Metadata: includedProcesses: This dataset describes the transport needed for an average export of Azerbaijani natural gas. Gas losses and emissions during seasonal storage are included. · technology: The distance is an European average based on the European long-distance pipeline network and LNG shipping routes. · comment: In 2023 100% of the imported Azerbaijani natural gas to GLO was imported by pipeline and 0% as LNG. An average distance of 3420 km is estimated for the pipeline export from Azerbaijan, of which are 110 km offshore pipeline. The estimated shipping distance for LNG are 0 km. The net calorific value of
