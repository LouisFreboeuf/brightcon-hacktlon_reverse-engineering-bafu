...
Dataset: `Tempering, flat glass` [RER], 1 kg, BAFU category glass / unspecified.
Metadata: includedProcesses: Gate to gate inventory for the process not including infrastructure and emissions. · technology: The glass sheet is heated to a temperature just below its softening point (about 640°C) and then immediately cooled by special jets of cold-air. These harden the surface of the glass, giving the insid · comment: Basic assumption of unit process raw data for the tempering of glass. Tempering or toughening is a special process of solidification of a glass sheet in order to make it particularly resistant to breakages. The process may be physical (thermal) or chemical. Here a thermal tempering is assumed. The r
