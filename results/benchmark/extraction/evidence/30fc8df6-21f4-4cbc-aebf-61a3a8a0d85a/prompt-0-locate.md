...
Dataset: `Disposal, waste, silicon wafer production, 0% water, to underground deposit` [DE], 1 kg, BAFU category underground deposit / unspecified.
Metadata: includedProcesses: waste packaging, process material and energy demands for underground disposal in old salt mine (Herfa Neurode, Germany). · technology: Ordered, recorded and potentially retrievable deposition of various types of hazardous wastes (excluding radioactive, explosive, burnable, or infectious wastes) · comment: No emissions from waste material are inventoried. Operators claim absolute long-term safety after closure. Non-zero risk of mine flooding remains.;
Synonyms: various wastes from silicon wafer production for photovoltaic cells; 
UUID: 30fc8df6-21f4-4cbc-aebf-61a3a8a0d85a
