...
- item: electronic component, passive, unspecified, at plant  (input)
  quote: passive component     H                                                                                                                elect ronics   component     No        GLO                                            6.70E-01 kg                                     1     2.29
  search: electronic component passive unspecified at plant
  candidates:
    - Electronic component, passive, unspecified, at plant [GLO] (kilogram, 8 inputs)
    - Electronic component, unspecified, at plant [GLO] (kilogram, 2 inputs)
    - Electronic component, active, unspecified, at plant [GLO] (kilogram, 5 inputs)
- item: electronic component, active, unspecified, at plant  (input)
  quote: active component      H                                                                                                                elect ronics   component     No        GLO                                            3.30E-01 kg                                     1     2.29
  search: electronic component active unspecified at plant
  candidates:
    - Electronic component, active, unspecified, at plant [GLO] (kilogram, 5 inputs)
    - Electronic component, unspecified, at plant [GLO] (kilogram, 2 inputs)
    - Electronic component, passive, unspecified, at plant [GLO] (kilogram, 8 inputs)
