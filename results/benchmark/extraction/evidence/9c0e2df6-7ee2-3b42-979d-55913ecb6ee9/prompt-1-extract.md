...
The dataset `Electronic passive elements, washing machine, at plant` [CH], reference unit 1 p, is shipped in the BAFU-2026 database as a "system terminated" inventory: it has no technosphere inputs, only ~16 cumulative elementary flows. A public report documents the underlying process. Your job is to read the report excerpt and produce the *unit process* as line items — what the process consumes from other datasets and what it emits directly — each traceable to the excerpt.

## What the database says about the dataset

- BAFU category: private consumption / household devices
- includedProcesses: This process describes the material and related transport requirements for the electronic parts (without printed wiring boards) of a washing machine.
- technology: Electronic passive elements for an actual washing machine for a household.
- generalComment: The material requirements are based on the measured average weight of the different parts (diodes, capacitors, etc.) and of an average composition of the parts. Transport distances are standard distances for the raw materials.;
UUID: 9c0e2df6-7ee2-3b42-979d-55913ecb6ee9
...
Source file: `report-p193-196.txt` (SHA-256 e8d0950d85bddf89109ac55093fb6bc90d13ae620015c3c401679260d962115d), pages 193-196 of `2007 - LCI electric and electronic equipment - Hischier.pdf`.

```
11. Unspecified datasets for electronic components


11.1.1 System Characterization & Life Cycle Inventory
The datasets represents an average composition of passive components as it can be found on printed
wiring boards in television devices, desktop computers and laptop computers. The following in Tab.
11.1 listed components are passive components and thus are taken into account here: connectors, ca-
pacitors, inductors and resitors.
Calculating the average from the three printed wiring boards in Tab. 11.1, results in the distribution for
the passive components that is used here in order to establish this unspecified dataset (the used specific
datasets for the respective components are mentioned here as well) – shown in Tab. 11.3.

Tab. 11.3   Composition of the unspecified dataset for passive components (data represent average composition of
            PWB from television, desktop computer and laptop computer)


                         Used dataset                                                     [%]
                         connectors, PCI bus, at plant                                   18.2%
                         connectors, computer, peripherical type, at plant               10.3%
                         capacitor, Tantalum-, through-hole mounting, at plant           3.5%
                         capacitor, electrolyte type, < 2cm height, at plant             13.9%
                         capacitors, SMD type, surface-mounting, at plant                4.4%
                         capacitors, unspecified, at plant                               10.5%
                         inductor, ring core choke type, at plant                        33.6%
                         resistor, unspecified, at plant                                 5.7%




11.1.2 Data Uncertainty and Input Data for ecoinvent Database
...
age of various passive components shown in this database – weighted on the basis of three different
types of printed wiring board. Nevertheless, the uncertainty values are rather high.
The resulting unit process “electronic component, passive, unspecified, at plant” is shown in Tab. 11.5
(on page 183).


11.2        Dataset “electronic component, active, unspecified, at plant”
This dataset here represents an average composition of active electronic components, based on the
composition of three different types of printed wiring board (see Tab. 11.1) for all those cases, where
active components are not further specified. The dataset has a functional unit of “1 kg of active com-
ponents”.


11.2.1 System Characterization & Life Cycle Inventory
The datasets represents an average composition of active components as it can be found on printed
wiring boards in television devices, desktop computers and laptop computers. The following in Tab.
11.1 listed components are active components and thus are taken into account here: transistors, inte-
grated circuits, and diodes (including light emitting diode, LED).




ecoinvent report No. 18 / part I                           - 181 -
                                     11. Unspecified datasets for electronic components
