...
Dataset: `Electronic passive elements, washing machine, at plant` [CH], 1 p, BAFU category private consumption / household devices.
Metadata: includedProcesses: This process describes the material and related transport requirements for the electronic parts (without printed wiring boards) of a washing machine. · technology: Electronic passive elements for an actual washing machine for a household. · comment: The material requirements are based on the measured average weight of the different parts (diodes, capacitors, etc.) and of an average composition of the parts. Transport distances are standard distances for the raw materials.;
