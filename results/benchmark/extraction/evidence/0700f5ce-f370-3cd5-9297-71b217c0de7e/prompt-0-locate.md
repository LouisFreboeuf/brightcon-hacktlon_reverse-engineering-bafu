...
Dataset: `Heat, residential, by transfer of geothermal heat using ground source heat pump using electricity from grid` [CH], 1 MJ, BAFU category energy, obsolete / heat, obsolete\heat pumps, obsolete\transformation.
