...
3. Location: prefer the process's own location (GQ), then RER/Europe, then CH, then GLO. If the candidate list shows several locations, name the one you choose.
