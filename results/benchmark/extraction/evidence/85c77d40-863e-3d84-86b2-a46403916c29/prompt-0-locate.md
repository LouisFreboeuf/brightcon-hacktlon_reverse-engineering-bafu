...
Dataset: `Sanitary ceramics, at regional storage` [CH], 1 kg, BAFU category ceramics / unspecified.
Metadata: includedProcesses: gate to gate production of sanitary ceramics, including transports of raw materials to factory and of product to Switzerland · technology: large scale production in Europe. Gas fired kiln · comment: Data from one producer only. Composition of ceramic might differ from case to case. This dataset refers to oxidic ceramics.;
