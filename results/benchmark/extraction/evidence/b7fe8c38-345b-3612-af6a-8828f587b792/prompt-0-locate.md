...
Dataset: `Transport, passenger car, plugin gasoline hybrid, label-certified electricity, Large SUV, 2013, EURO-5` [CH], 1 km, BAFU category transport systems / road\Transformation.
Metadata: includedProcesses: — · technology: Driving cycle: WLTC. Combustion engine power: 94 [kW]. Electric motor power: 81 [kW]. Power share from combustion engine: 54 [%]. Km over lifetime: 200000 [km]. Yearly mileage: 12000 [km/year]. Autono · comment:  Driving cycle: WLTC. Combustion engine power: 94 [kW]. Electric motor power: 81 [kW]. Power share from combustion engine: 54 [%]. Km over lifetime: 200000 [km]. Yearly mileage: 12000 [km/year]. Autonomy on a full tank/battery: 650 [km]. Tank-to-wheel efficiency: 40 [%]. Tank-to-wheel energy consump
