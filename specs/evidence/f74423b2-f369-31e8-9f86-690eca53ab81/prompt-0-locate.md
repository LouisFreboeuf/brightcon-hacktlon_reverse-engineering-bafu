...
Dataset: `Gypsum block, at plant` [DE], 1 m2, BAFU category construction materials / gypsum materials.
Metadata: includedProcesses: <null> · technology: Data from German manufacturers · comment: Gips-Wandbauplatte / Vollgipsplatte Standard, Herstellung\n1m2 Platte, Flächengewicht 84 kg/m2, Stärke 84-100 mm (je nach Hersteller unterschiedlich), Rohdichte ca. 850-1000 kg/m3\nTechnology: Data from German manufacturers\nVersion: 0.0\nEnergy values: Undefined\nLocal category: construction materi
