...
Dataset: `Titanium dioxide at plant, sulphate process, at plant` [RER], 1 kg, BAFU category chemicals / inorganic.
Metadata: includedProcesses: Cradle-to-gate, includes all ancillary materials, precursors, transports and infrastructure. · technology: represents a current cross-section of actual plants in Europe · comment: Titanium dioxide produced by the sulfate process is preferred for paper, ink, rubber and a variety of specialty applications. Inventory data are confidential;
