...
Dataset: `Pyrolysis gasoline, production mix, at plant` [RER], 1 kg, BAFU category plastics / others.
Metadata: includedProcesses: All processes are considererd including waste treatment of process waste · technology: The world-wide demand for lower olefins, i.e. ethylene, propylene and butadienes is higher than for any other chemical as they are the primary feedstock for most plastics, polymers and man-made fibres · comment: A methane emissions update has been incorporated into the LCI of datasets downloaded from the PlasticsEurope website. UUID=dab0fa22-ba8d-34a9-b594-c980886b0b14
