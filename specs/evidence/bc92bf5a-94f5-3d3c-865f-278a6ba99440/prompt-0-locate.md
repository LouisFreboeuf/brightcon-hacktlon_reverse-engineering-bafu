...
Dataset: `Titanium dioxide, chloride process, at plant` [RER], 1 kg, BAFU category chemicals / inorganic.
Metadata: includedProcesses: Cradle-to-gate, includes all ancillary materials, precursors, transports and infrastructure. · technology: represents a current cross-section of actual plants in Europe · comment: Titanium dioxide produced by the chloride process, preferred by paint, coatings and plastics manufacturers. Inventory data are confidential;
