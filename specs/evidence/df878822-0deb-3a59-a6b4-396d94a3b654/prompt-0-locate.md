...
Dataset: `Polyethylene, LLDPE, granulate, at plant` [RER], 1 kg, BAFU category plastics / thermoplasts.
Metadata: includedProcesses: The polymer  process, upstream processes like ethylene production, electricity, and steam production as well as transportation of feedstock and waste treatment. · technology: The polymer process, upstream processes like ethylene production, electricity, and steam production as well as transportation of feedstock and waste treatment.
 · comment: A methane emissions update has been incorporated into the LCI of datasets downloaded from the PlasticsEurope website. UUID=df878822-0deb-3a59-a6b4-396d94a3b654
