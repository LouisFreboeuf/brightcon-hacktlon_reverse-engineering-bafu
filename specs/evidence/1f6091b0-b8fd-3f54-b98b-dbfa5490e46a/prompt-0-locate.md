...
Dataset: `Toluene, liquid, at plant` [RER], 1 kg, BAFU category chemicals / organic.
Metadata: includedProcesses: Aggregated data for all processes from raw material extraction until delivery at plant · technology: production by catalytic reforming out of naphtha · comment: Data are from the Eco-profiles of the European plastics industry (PlasticsEurope). Not included are the values reported for: recyclable wastes, amount of air / N2 / O2 consumed, unspecified metal emission to air and to water, mercaptan emission to air, unspecified CFC/HCFC emission to air, dioxin to
