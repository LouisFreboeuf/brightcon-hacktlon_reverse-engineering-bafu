...
Dataset: `Polystyrene, expandable, at plant` [RER], 1 kg, BAFU category plastics / thermoplasts.
Metadata: includedProcesses: All processes are considererd including waste treatment of process waste · technology: Expandable Polystyrene (EPS) is produced by polymerisation of styrene monomer, a chain-growth reaction which is mostly initiated by free radical organic initiators. EPS beads are produced by suspensio · comment: A methane emissions update has been incorporated into the LCI of datasets downloaded from the PlasticsEurope website. UUID=05a10e4b-a919-33b6-b017-7c0bf7f7a7f9
