...
Dataset: `Xylene, at plant` [RER], 1 kg, BAFU category chemicals / organic.
Metadata: includedProcesses: All processes are considererd including waste treatment of process waste · technology: "Xylenes are commercially produced based on two different feedstocks:
- Pyrolysis gasoline, a side product of thermal cracking (steam cracking) of hydrocarbons (e.g. naphtha, gas oil, ethane, propane, · comment: A methane emissions update has been incorporated into the LCI of datasets downloaded from the PlasticsEurope website. UUID=a29aa0d5-9e37-34d7-8868-8a4fff95350a
