...
Dataset: `Gypsum plaster board, at plant` [DE], 1 m2, BAFU category construction materials / gypsum materials.
Metadata: includedProcesses: <null> · technology: Industrial processes as in use in German gypsum industry · comment: Gipskartonplatte Standard, Herstellung\n1m2 Platte, Flächengewicht 10 kg/m2, Stärke ca. 12.5 mm, Rohdichte = 680 kg/m3\nTechnology: Industrial processes as in use in German gypsum industry\nVersion: 0.0\nEnergy values: Undefined\nLocal category: construction materials\nLocal subcategory: Gipswerksto
