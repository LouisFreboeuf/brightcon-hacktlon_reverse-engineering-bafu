...
Dataset: `Tetrachloroethylene, at plant` [WEU], 1 kg, BAFU category chemicals / organic.
Metadata: includedProcesses: Raw materials, processing energy, emissions to air and water from process, energy services and transports, infrastructure only partly included, no infrastructure of main process included, no land use data included. · technology: Data refers to actual technology used in the companies included. This leads in total to an average value including all important production routes for this chemical · comment: The data source for this process is a system inventory from Boustead. Due to the cumulated form of this data only the ressources and emissions included in the data source were considered. No land occupation and land use is included in this dataset. Further it was not possible to implement an uncerta
