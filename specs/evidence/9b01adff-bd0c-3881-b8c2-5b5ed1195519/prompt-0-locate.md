...
Dataset: `Tyre wear emissions, lorry` [RER], 1 kg, BAFU category transport systems / road.
Metadata: includedProcesses: The activity starts with the abrasion of lorry tyres on the road. The activity ends with emissions of lorry tyre wear. · technology: Unspecified · comment: Calculation of non-exhaust emissions (tyre, brake and road wear emissions) are based on EMEP/EEA (2013) and values for net vehicle weights and average load factors. Net vehicle weights are taken from the EcoTransIT (2011) report whilst the average load factors are taken from the Tremove model v2.7b 
