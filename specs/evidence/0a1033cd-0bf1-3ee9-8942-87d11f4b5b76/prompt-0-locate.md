...
Dataset: `Carbon tetrachloride, at plant` [RER], 1 kg, BAFU category chemicals / organic.
Metadata: includedProcesses: Aggregated data for all processes from raw material extraction until delivery at plant · technology: production by three different routes (methane with chlorine / chlorination of chloromethane / chlorination of higher hydrocarbons) · comment: Data are from the Eco-profiles of the European plastics industry (APME). Not included are the values reported for: recyclable wastes, amount of air / N2 / O2 consumed, unspecified metal emission to air and to water, mercaptan emission to air, unspecified CFC/HCFC emission to air. The amount of "sulp
