...
Dataset: `Polyethylene terephthalate, granulate, bottle grade, at plant` [RER], 1 kg, BAFU category plastics / thermoplasts.
Metadata: includedProcesses: The polymer process, upstream processes like pX, PTA, and MEG production, electricity, and steam production as well as transportation of feedstock and waste treatment. · technology: The dataset represents the production mix of commercial PET production technologies in Europe · comment: A methane emissions update has been incorporated into the LCI of datasets downloaded from the PlasticsEurope website. UUID=c7af8832-9551-38fd-a628-363e6fc17c8e
