...
Dataset: `Vinyl chloride, at plant` [RER], 1 kg, BAFU category chemicals / organic.
Metadata: includedProcesses: The VCM production  process, upstream processes like ethylene and chlorine production, electricity, and steam production as well as transportation of feedstock and waste treatment. · technology: The VCM production process, upstream processes like ethylene and chlorine production, electricity, and steam production as well as transportation of feedstock and waste treatment. · comment: A methane emissions update has been incorporated into the LCI of datasets downloaded from the PlasticsEurope website. UUID=99a93e93-a8a8-34f3-88f3-6af0c21c4762
