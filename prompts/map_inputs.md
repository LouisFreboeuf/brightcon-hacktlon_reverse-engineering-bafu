...
3. Location: prefer the process's own location ({{target_location}}), then RER/Europe, then CH, then GLO. If the candidate list shows several locations, name the one you choose.
